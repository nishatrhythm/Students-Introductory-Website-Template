...
function createStudentCard(student) {
    ...
    // image.src = `/repository_name/images/${student.id}.jpg`;
    ...
    try {
        ...
        function updatePaginationButtons() {
            ...
            const filteredStudents = students.filter((student) => {
                const searchData = `${student.name} B19${student.id} ${student.school} ${student.college} ${student.hometown}`.toLowerCase();
        ...
        function filterStudents(query, students) {
            ...
            return students.filter((student) => {
                ...
                if (searchData.includes(`b19${query}`)) {
                    return true;
                }
